...
# adata <- sc$read("/home/gabrielarapozo/sc_breast/data/colab_ufv/02_object/malignant_pos_scVI.h5ad")
# exprs <- t(adata$raw$X)
...
# saveRDS(seurat, '/home/gabrielarapozo/sc_breast/data/colab_ufv/02_object/malignant_seurat.rds')
```

```{r}
seurat <- readRDS('/home/gabrielarapozo/sc_breast/data/colab_ufv/02_object/malignant_seurat.rds')
```
...
melanoma_seurat <- readRDS('/home/gabrielarapozo/sc_breast/data/colab_ufv/02_object/melanoma_seurat.rds')
