...
# saveRDS(seurat, '/home/gabrielarapozo/sc_breast/data/colab_ufv/02_object/melanoma_seurat.rds')
```

```{r}
seurat <- readRDS('/home/gabrielarapozo/sc_breast/data/colab_ufv/02_object/melanoma_seurat.rds')
```
